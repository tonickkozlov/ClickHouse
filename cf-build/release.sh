...
export CMAKE_FLAGS="${CMAKE_FLAGS} -DENABLE_KRB5=OFF -DENABLE_S3=OFF -DENABLE_RDKAFKA=OFF -DENABLE_EMBEDDED_COMPILER=OFF -DENABLE_AMQPCPP=OFF -DENABLE_CASSANDRA=OFF -DENABLE_MSGPACK=OFF -DENABLE_AVRO=OFF -DENABLE_PROTOBUF=OFF -DENABLE_GRPC=OFF -DENABLE_ARROW=0 -DENABLE_ORC=0 -DENABLE_PARQUET=0 -DENABLE_HDFS=0 -DENABLE_MYSQL=0"
