...
node1 = cluster.add_instance('node1', with_odbc_drivers=True, with_postgres=True,
                             main_configs=['configs/openssl.xml', 'configs/odbc_logging.xml'],
                             dictionaries=['configs/dictionaries/postgres_odbc_hashed_dictionary.xml'], stay_alive=True)
...
# Broken w/ psqlodbc packaged for buster.
